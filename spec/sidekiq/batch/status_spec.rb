...
describe Sidekiq::Batch::Status do
  ...
  describe '#data' do
    it 'returns batch data' do
      expect(subject.data).to eq(total: 0, failures: 0, pending: 0, created_at: nil, complete: false, failure_info: [], parent_bid: nil, description: nil, successes: 0)
    end
  end
